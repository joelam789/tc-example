...
namespace SimpleSharpServer
{
    static class Program
    {
        ...
        public static string MUTE_VAR = "SimpleSharpServer";
        public static string SVC_NAME = "SimpleSharpServer";
        public static string SVC_DESC = "SimpleSharpServer";

        public static int EXTRA_STOP_SVC_SECONDS = 2;
        public static int EXTRA_START_SVC_SECONDS = 2;
        ...
        public static int Main(string[] args)
        {
            ...
            {
                if (key == "MuteVarName") MUTE_VAR = appSettings[key];
                if (key == "ServiceName") SVC_NAME = appSettings[key];
                if (key == "ServiceDescription") SVC_DESC = appSettings[key];

                if (key == "ExtraStartServiceSeconds") EXTRA_START_SVC_SECONDS = Convert.ToInt32(appSettings[key].ToString());
                if (key == "ExtraStopServiceSeconds") EXTRA_STOP_SVC_SECONDS = Convert.ToInt32(appSettings[key].ToString());
            }
